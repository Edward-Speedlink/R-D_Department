...
const Pricing = () => {
  ...
  const calculateEstimate = () => {
    ...
    const levelMultiplier = estimatorForm.academicLevel === "Graduate" ? 1.3 : 1
...
//   &:hover {
//     background: ${(props) => !props.active && "rgba(59, 130, 246, 0.1)"};
//   }
...
//   border: 2px solid ${(props) => (props.featured ? "#3b82f6" : "rgba(59, 130, 246, 0.2)")};
//   border-radius: 16px;
//   padding: 2.5rem;
//   position: relative;
//   transition: all 0.3s ease;
...
//   width: 100%;
//   padding: 1rem;
//   background: ${(props) => (props.featured ? "linear-gradient(135deg, #3b82f6 0%, #1e40af 100%)" : "transparent")};
...
//       {
//         name: "Small Project",
//         complexity: "Simple - Single Module",
//         price: "$500",
//         timeline: "2-4 weeks",
//         features: ["Basic functionality", "Simple database", "Documentation", "1 revision round"],
//       },
//       {
//         name: "Medium Project",
//         complexity: "Moderate - Multi-Module",
//         price: "$1,200",
//         timeline: "4-8 weeks",
//         features: [
//           "Multi-module system",
...
//         complexity: "Advanced - Full System",
//         price: "$2,500",
//         timeline: "8-12 weeks",
//         features: [
//           "Complete solution",
...
//         complexity: "Advanced - Research-Focused",
//         price: "$1,500",
//         timeline: "4-8 weeks",
//         features: ["Advanced algorithms", "Research papers", "Detailed documentation", "Performance analysis"],
//       },
//       {
...
//       {
//         name: "Thesis Project",
//         complexity: "Comprehensive - Thesis-Level",
//         price: "$5,000",
...
//   const data = isGraduate ? pricingData.graduate : pricingData.undergraduate

//   return (
//     <PricingWrapper id="pricing">
//       <Container>
//         <SectionTitle>Transparent Pricing</SectionTitle>
//         <SectionSubtitle>Flexible plans for undergraduate and graduate projects</SectionSubtitle>

//         <PricingToggle>
//           <ToggleButton active={!isGraduate} onClick={() => setIsGraduate(false)}>
//             Undergraduate
//           </ToggleButton>
//           <ToggleButton active={isGraduate} onClick={() => setIsGraduate(true)}>
//             Graduate
//           </ToggleButton>
//         </PricingToggle>
...
//               </PriceTag>
//               <Timeline>⏱️ Timeline: {plan.timeline}</Timeline>
//               <FeaturesList>
